// NodeCompleteRule 모델 관리자 페이지용 스크립트
...
function initNodeCompleteRuleAdmin($) {
    console.log('NodeCompleteRule admin 스크립트 초기화');
    
    if ($('#id_map').length > 0 && $('#id_node').length > 0) {
