-- NoSQL 학습 Self-referencing Arrows 생성
WITH map_id AS (
...
-- 기초 이론 그룹 Self-referencing Arrows
((SELECT id FROM map_id),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'nosql_intro' LIMIT 1),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'nosql_intro' LIMIT 1),
 (SELECT id FROM map_nodecompleterule WHERE map_id = (SELECT id FROM map_id) AND name = 'NoSQL 소개 학습' LIMIT 1),
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'NoSQL의 개념과 특징' LIMIT 1),
 false, NOW(), NOW()),

((SELECT id FROM map_id),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'nosql_types' LIMIT 1),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'nosql_types' LIMIT 1),
 (SELECT id FROM map_nodecompleterule WHERE map_id = (SELECT id FROM map_id) AND name = 'NoSQL 유형 이해' LIMIT 1),
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'NoSQL 데이터베이스 유형' LIMIT 1),
 false, NOW(), NOW()),

((SELECT id FROM map_id),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'cap_theorem' LIMIT 1),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'cap_theorem' LIMIT 1),
 (SELECT id FROM map_nodecompleterule WHERE map_id = (SELECT id FROM map_id) AND name = 'CAP 이론 학습' LIMIT 1),
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'CAP 이론 이해하기' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'NoSQL 데이터 모델링' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'ACID와 BASE' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = '확장성 패턴' LIMIT 1),
 false, NOW(), NOW()),

-- MongoDB 그룹 Self-referencing Arrows
((SELECT id FROM map_id),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'mongo_basics' LIMIT 1),
 (SELECT id FROM map_node WHERE map_id = (SELECT id FROM map_id) AND name = 'mongo_basics' LIMIT 1),
 (SELECT id FROM map_nodecompleterule WHERE map_id = (SELECT id FROM map_id) AND name = 'MongoDB 기초 학습' LIMIT 1),
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'MongoDB 기초' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'MongoDB CRUD 실습' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'MongoDB 집계 파이프라인' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'MongoDB 인덱싱' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'MongoDB 복제' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'MongoDB 샤딩' LIMIT 1),
 false, NOW(), NOW()),

-- Redis 그룹 Self-referencing Arrows
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Redis 기초' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Redis 데이터 타입' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Redis 영속성' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Redis Pub/Sub' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Redis 캐시 설계' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Redis 클러스터' LIMIT 1),
 false, NOW(), NOW()),

-- Cassandra 그룹 Self-referencing Arrows
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Cassandra 데이터 모델링' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Cassandra 클러스터 설계' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Cassandra 기초' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Cassandra 아키텍처' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'Cassandra 일관성' LIMIT 1),
 false, NOW(), NOW()),

-- 실전/응용 그룹 Self-referencing Arrows
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = '마이그레이션 전략' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = '성능 최적화' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'NoSQL 활용 사례' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = 'NoSQL 보안' LIMIT 1),
 false, NOW(), NOW()),
...
((SELECT id FROM map_id),
 ...
 (SELECT id FROM question_question WHERE map_id = (SELECT id FROM map_id) AND title = '백업과 복구' LIMIT 1),
 false, NOW(), NOW()); 